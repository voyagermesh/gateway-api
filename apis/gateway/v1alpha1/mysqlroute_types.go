...
// listener to a set of backends specified by the MySQLRoute.
type MySQLRoute struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	// Spec defines the desired state of MySQLRoute.
	Spec MySQLRouteSpec `json:"spec"`

	// Status defines the current state of MySQLRoute.
	Status MySQLRouteStatus `json:"status,omitempty"`
}
...
// MySQLRouteList contains a list of MySQLRoute
type MySQLRouteList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MySQLRoute `json:"items"`
}
