...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AuthSecretRefWithKeys) DeepCopyInto(out *AuthSecretRefWithKeys) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthSecretRefWithKeys.
func (in *AuthSecretRefWithKeys) DeepCopy() *AuthSecretRefWithKeys {
	if in == nil {
		return nil
	}
	out := new(AuthSecretRefWithKeys)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RedisRouteSpec) DeepCopyInto(out *RedisRouteSpec) {
	*out = *in
	...
	if in.DownstreamAuthSecretRefs != nil {
		in, out := &in.DownstreamAuthSecretRefs, &out.DownstreamAuthSecretRefs
		*out = make([]AuthSecretRefWithKeys, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	out.UpstreamAuthSecretRef = in.UpstreamAuthSecretRef
}
