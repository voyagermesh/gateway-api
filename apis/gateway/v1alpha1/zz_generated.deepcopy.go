...
func (in *BackendTLSPolicyConfig) DeepCopyInto(out *BackendTLSPolicyConfig) {
	*out = *in
	if in.CertRefs != nil {
		in, out := &in.CertRefs, &out.CertRefs
		*out = make([]ConfigMapObjectReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.StandardCerts != nil {
		in, out := &in.StandardCerts, &out.StandardCerts
		*out = new(StandardCertType)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigMapObjectReference) DeepCopyInto(out *ConfigMapObjectReference) {
	*out = *in
	if in.Group != nil {
		in, out := &in.Group, &out.Group
		*out = new(v1beta1.Group)
		**out = **in
	}
	if in.Kind != nil {
		in, out := &in.Kind, &out.Kind
		*out = new(v1beta1.Kind)
		**out = **in
	}
	if in.Namespace != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigMapObjectReference.
func (in *ConfigMapObjectReference) DeepCopy() *ConfigMapObjectReference {
	if in == nil {
		return nil
	}
	out := new(ConfigMapObjectReference)
	in.DeepCopyInto(out)
	return out
}
